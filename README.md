...
**Note:** This is a [Sourcegraph](https://github.com/aetimmes/zoekt) fork
...
## Downloading
    ...
    go get github.com/aetimmes/zoekt/

## Indexing

### Directory

    go install github.com/aetimmes/zoekt/cmd/zoekt-index
    $GOPATH/bin/zoekt-index .

### Git repository

    go install github.com/aetimmes/zoekt/cmd/zoekt-git-index
    $GOPATH/bin/zoekt-git-index -branches master,stable-1.4 -prefix origin/ .

### Repo repositories

    go install github.com/aetimmes/zoekt/cmd/zoekt-{repo-index,mirror-gitiles}
...
### Web interface
    ...
    go install github.com/aetimmes/zoekt/cmd/zoekt-webserver
...
The response data is a JSON object. You can refer to [web.ApiSearchResult](https://sourcegraph.com/github.com/aetimmes/zoekt@6b1df4f8a3d7b34f13ba0cafd8e1a9b3fc728cf0/-/blob/web/api.go?L23:6&subtree=true) to learn about the structure of the object.

### CLI

    go install github.com/aetimmes/zoekt/cmd/zoekt
...
Zoekt comes with a small service management program:
    ...
    go install github.com/aetimmes/zoekt/cmd/zoekt-indexserver
